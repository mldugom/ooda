...
class DomainControlRoomTests(unittest.TestCase):
    def test_promotes_goal_decision_bottleneck_mission_and_why_now(self):
        ...
        self.assertIn("DOMAIN / VALUE CONTROL", page)
        self.assertIn("GOAL / VALUE FUNCTION", page)
        self.assertIn("DECISION SERVED", page)
        self.assertIn("CURRENT BOTTLENECK", page)
        ...
        self.assertIn("Technical/project-state objective: STALE: R7 preregistration", page)
